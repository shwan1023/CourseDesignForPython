$(function () {
    ...
    function ceshis1() {
        ...
        var xdata = ['农林牧渔业', "工业", "建筑业", "批发零售", '互联网行业', '邮政运储', '住宿餐饮', '金融业','房地产','其他'];
    ...
    function ceshis3() {
        ...
        option = {
            ...
            series: [{
                name: '软件业务收入',
                type: 'bar',
                data:  [13589, 18849, 24793, 30587, 37026, 42847, 48232, 55103, 61909, 72072, 81586, 94994],
                itemStyle: {
                    normal: {
                        barBorderRadius: 2
                    }
            ...
            },
                {
                    ...
                    type: 'bar',
                    yAxisIndex: 1,
                    data:  [6529, 9583, 12944, 16030, 18711, 22210, 26090, 30603, 37563, 43580, 52588, 62909],
                    itemStyle: {
                        normal: {
                            barBorderRadius: 2
                        }
...
// }
        ...
        var geoCoordMap = {
            '生产总值': [118.8062, 31.9208],
            '第一产业': [127.9688, 45.368],
            '第二产业': [110.3467, 41.4899],
            '第三产业': [116.4551, 40.2539],
            "金融业": [123.1238, 42.1216],
            "房地产": [87.9236, 43.5883],
            "住宿餐饮": [103.9526, 30.7617],
            "邮政运储": [117.29, 32.0581],
            "商品贸易": [106.6992, 26.7682],
            "农林牧鱼": [108.479, 23.1152],
        };
